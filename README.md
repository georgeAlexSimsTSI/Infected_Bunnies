...
radioactive_mutant_infected_bunny: true/false (decided at time of bunny creation 2% chance of true)
...
If a radioactive mutant infected bunny is born then each turn it will change exactly one non radioactive bunny into a radioactive infected bunny.
(if there are two radioactive mutant infected bunnies two bunnies will be changed each turn and so on...)
Radioactive infected bunnies are excluded from regular breeding and do not count as adult bunnies.
Radioactive infected bunnies do not die until they reach age 50.
The program should print a list of all the bunnies in the colony each turn along w/ all the bunnies details, sorted by age.
The program should also output each turns events such as
"Bunny Thumper was born!
Bunny Fufu was born!
Radioactive Mutant Infected Bunny Darth Maul was born!
...
radioactive mutant infected bunnies with X

Modify the program so that radioactive mutant infected bunnies only convert bunnies that end a turn on an adjacent square.
...
# change enums to enum class, this will break certain checks